    ...
    <div className="app-shell" id="notebook-top">
      ...
      <main className="main-canvas">
        ...
        <div className="workspace-content">
          ...
          <footer className="site-footer"><span>Lecture Notebook AI · a focused, privacy-first study workspace</span><span>v1.02 · local-first</span></footer>
        </div>
      </main>
